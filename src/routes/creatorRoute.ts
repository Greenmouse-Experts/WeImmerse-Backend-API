...
creatorRoutes.get("/course/statistics", authMiddleware, authorizeCreator, creatorController.courseStatistics);
creatorRoutes.post("/course/publish", authMiddleware, authorizeCreator, creatorController.coursePublish);
