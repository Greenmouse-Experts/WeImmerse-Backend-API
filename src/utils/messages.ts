...
<html>
  ...
  sendCoursePublishRequestNotification: async (
    adminEmail: string,
    courseTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
  ...
  sendCoursePublishedNotification: async (
    creatorEmail: string,
    courseTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
  ...
  sendCourseUnpublishedNotification: async (
    creatorEmail: string,
    courseTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
  ...
  sendDigitalAssetPublishRequestNotification: async (
    adminEmail: string,
  ...
  sendDigitalAssetPublishedNotification: async (
    creatorEmail: string,
    digitalAssetTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
  ...
  sendDigitalAssetUnpublishedNotification: async (
    creatorEmail: string,
    digitalAssetTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
  ...
  sendJobPostPublishRequestNotification: async (
    adminEmail: string,
    jobPostTitle: string
  ) => {
    const logoUrl = process.env.LOGO_URL;
